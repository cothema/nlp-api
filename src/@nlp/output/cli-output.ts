...
export class CliOutput {
  ...
  static echoSentence(sentence: Sentence): void {
  ...
  static translateSentenceType(sentenceType: SentenceType): string {
    switch (sentenceType) {
